...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('admin.alumni.pending') }}" class="btn btn-warning shadow-sm fw-bold">
            <i class="fas fa-user-clock me-1"></i> View Pending Claims
        </a>
    </div>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="badge badge-info px-2 py-1">{{ $alum->year_graduated ?? 'Unknown' }}</span></td>
                            <td>
            ...
            </div> </div> {{-- 🟢 Correct Pagination Integration --}}
        @if($alumni->hasPages())
