...
@section('content')
    @php
        // Registration form settings may be missing on fresh installs.
        // Use safe defaults to prevent null-property crashes.
                    ...
                    <table class="table zTable" id="alumni-all-list-filter">
                        ...
                        <tr>
                            ...
                            @if($rfEnablePassingYear)
                                <th scope="col">
                                    <div class="min-w-110">{{ __('Passing Year') }}</div>
                                </th>
                            @endif
                            <th scope="col">
                                <div>{{ __('Location') }}</div>
...
@push('script')
    <script>
        var enable_passing_year = '{{ $rfEnablePassingYear ? 1 : 0 }}';
        var enable_department = '{{ $rfEnableDepartment ? 1 : 0 }}';
        var enable_batch = '{{ $rfEnableBatch ? 1 : 0 }}';
    </script>
