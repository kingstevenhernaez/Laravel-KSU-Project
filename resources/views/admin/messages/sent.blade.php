                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="d-flex justify-content-center gap-2">
                                    ...
                                    <form action="{{ route('admin.messages.destroy', $msg->id ?? 1) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this log?');">
                                        @csrf
                                        @method('DELETE')
                        ...
                        <tr>
                            <td colspan="4" class="text-center py-5 text-muted">
                                ...
                                @if(request()->has('search') && request('search') != '')
                                    <p class="small">No results match your search. <a href="{{ route('admin.messages.sent') }}">Clear search.</a></p>
                                @else
