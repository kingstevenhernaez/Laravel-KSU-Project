...
<div class="container-fluid py-4">
    ...
    @php
        // Decode their current roles to pre-check the boxes
        $raw = $user->role_name ?? '[]';
                        ...
                        <div class="row g-4">
                                ...
                                <div class="card h-100 border-0 shadow-sm rounded-4">
                                    ...
                                    <div class="card-body bg-light">
                                        <div class="form-check mb-2">
                                            <input class="form-check-input" type="checkbox" name="role_name[]" value="manage_staff" id="p_staff" {{ in_array('manage_staff', $currentRoles) ? 'checked' : '' }}>
                                            <label class="form-check-label" for="p_staff">Staff Management</label>
                                        </div>
                                        <div class="form-check mb-2">
                                            <input class="form-check-input" type="checkbox" name="role_name[]" value="mis_sync" id="p_mis" {{ in_array('mis_sync', $currentRoles) ? 'checked' : '' }}>
                                            <label class="form-check-label" for="p_mis">MIS Synchronization</label>
                                        </div>
                                        <div class="form-check mb-2">
                                            <input class="form-check-input" type="checkbox" name="role_name[]" value="alumni_list" id="p_alumni" {{ in_array('alumni_list', $currentRoles) ? 'checked' : '' }}>
                                            <label class="form-check-label" for="p_alumni">Master Alumni List</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="role_name[]" value="pending_claims" id="p_pending" {{ in_array('pending_claims', $currentRoles) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4">
                                <div class="card h-100 border-0 shadow-sm rounded-4">
                                    ...
                                    <div class="card-body bg-light">
                                        <div class="form-check mb-2">
                                            <input class="form-check-input" type="checkbox" name="role_name[]" value="manage_events" id="p_events" {{ in_array('manage_events', $currentRoles) ? 'checked' : '' }}>
                                            <label class="form-check-label" for="p_events">University Events</label>
                                        </div>
                                        <div class="form-check mb-2">
                                            <input class="form-check-input" type="checkbox" name="role_name[]" value="manage_news" id="p_news" {{ in_array('manage_news', $currentRoles) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4">
                                <div class="card h-100 border-0 shadow-sm rounded-4">
                                    ...
                                    <div class="card-body bg-light">
                                        <div class="form-check mb-2">
                                            <input class="form-check-input" type="checkbox" name="role_name[]" value="email_blast" id="p_email" {{ in_array('email_blast', $currentRoles) ? 'checked' : '' }}>
                                            <label class="form-check-label" for="p_email">New Email Blast</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="role_name[]" value="email_history" id="p_history" {{ in_array('email_history', $currentRoles) ? 'checked' : '' }}>
