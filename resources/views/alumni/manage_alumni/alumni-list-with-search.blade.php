                ...
                <div class="table-responsive zTable-responsive">
                    <table class="table zTable" id="alumni-list-filter">
                        ...
                        <tr>
                            ...
                            @if ((int) data_get($regForm, 'enable_batch', 0) === 1)
                                <th scope="col" class="min-w-100">
                                    <div>{{ __('Batch') }}</div>
                                </th>
                            @endif

                            @if ((int) data_get($regForm, 'enable_passing_year', 0) === 1)
                                <th scope="col">
        ...
        <div class="collapse" id="collapseExample">
            <div class="alumniFilter">
                ...
                <div class="filterOptions">
                    ...
                    @if ((int) data_get($regForm, 'enable_department', 0) === 1)
                        <div class="item">
                            <div class="primary-form-group">
                                <div class="primary-form-group-wrap">
                                    <label for="Department" class="form-label">{{ __('Department') }}</label>
                                    <select class="sf-select-without-search primary-form-control" name="department" id="department">
                        ...
                        <div class="item">
                            <div class="primary-form-group">
                                <div class="primary-form-group-wrap">
                                    ...
                                    <select class="sf-select-without-search primary-form-control" name="passing_year" id="passing-year">
                    ...
                    <div class="item">
                        <div class="primary-form-group">
                            <div class="primary-form-group-wrap">
                                ...
                                <select class="sf-select-without-search primary-form-control" name="is_member" id="is-member">
                    ...
                    <button
                        class="bg-cdef84 border-0 bd-ra-12 py-13 px-26 fs-15 fw-500 lh-25 text-black hover-bg-one advance-filter">
                        {{ __('Search Now') }}
                    </button>
...
@push('script')
    <script>
        // Safe defaults when $regForm is null
        var enable_passing_year = '{{ (int) data_get($regForm, "enable_passing_year", 0) === 1 ? 1 : 0 }}';
        var enable_department   = '{{ (int) data_get($regForm, "enable_department", 0) === 1 ? 1 : 0 }}';
        var enable_batch        = '{{ (int) data_get($regForm, "enable_batch", 0) === 1 ? 1 : 0 }}';
    </script>
