...
@section('content')
    @php
        // Registration form settings can be null; prevent null-property crashes.
        $rfEnableBatch = (int) data_get($regForm, 'enable_batch', 0) === 1;
        $rfEnableDepartment = (int) data_get($regForm, 'enable_department', 0) === 1;
        $rfEnablePassingYear = (int) data_get($regForm, 'enable_passing_year', 0) === 1;
        $rfEnableRoleNumber = (int) data_get($regForm, 'enable_role_number', 0) === 1;
        $rfEnableBloodGroup = (int) data_get($regForm, 'enable_blood_group', 0) === 1;
        $rfEnableDob = (int) data_get($regForm, 'enable_date_of_birth', 0) === 1;
        $rfEnableGender = (int) data_get($regForm, 'enable_gender', 0) === 1;
        $rfEnableAttachment = (int) data_get($regForm, 'enable_attachment', 0) === 1;
    @endphp
    <div class="p-30">
        <div class="">
                    ...
                    <div class="col-lg-8">
                        <div class="py-20 px-25 bd-ra-10 bg-f9f9f9">
                            ...
                            <ul class="zList-one">
                                ...
                                @if ($rfEnableAttachment && auth()->user()->role == USER_ROLE_ADMIN)
                                    <li>
                                        <p>{{ __('Attachment') }} :</p>
