<style>
    :root {
        ...
        /* KSU Default Theme (applies when System Color = Default) */
        --primary-color: #0B5D1E;         /* KSU dark green */
        --hover-color: #0F7A28;           /* hover green */
        --black-color: #121421;
        --text-black: #1b1c17;
        --para-color: #707070;
        --black: #000000;
        ...
        --sidebar-text-color: #f5f7f5;
        --sidebar-bg-color: #073A12;
        --sidebar-hover-text-color: #C9A227; /* gold accent */
        @else
        /* Custom colors from admin settings */
        --primary-color: {{ getOption('app_primary_color', '#0B5D1E') }};
        ...
        --hover-color: {{ getOption('app_hover_color', '#0F7A28') }};
        --black: {{ getOption('app_text_color', '#000000') }};

        --sidebar-text-color: {{ getOption('app_sidebar_text_color', '#f5f7f5') }};
        --sidebar-bg-color: {{ getOption('app_sidebar_bg_color', '#073A12') }};
        /* IMPORTANT: use sidebar hover text color option if you have it; fallback to primary */
        --sidebar-hover-text-color: {{ getOption('app_primary_color', '#0B5D1E') }};
        @endif
