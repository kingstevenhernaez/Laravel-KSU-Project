...
use App\Http\Controllers\Admin\EnrollmentSyncController;
use App\Http\Controllers\Admin\TracerSurveyController;
use App\Http\Controllers\Admin\TracerSurveyQuestionController;
use App\Http\Controllers\Admin\AlumniJobHistoryController;
use App\Http\Controllers\Admin\JobHistoryReportController;
use App\Http\Controllers\Admin\TracerSurveyReportController;
use Illuminate\Support\Facades\Route;
use App\Http\Controllers\Admin\Analytics\EnhancedAnalyticsController;
use App\Http\Controllers\Admin\Analytics\AlumniReportController as AnalyticsAlumniReportController;
...
// KSU Analytics (Admin)
/**
 * Provides missing route names used by admin blades:
 * - admin.analytics.index
 * - admin.analytics.alumni_report.index
 * - admin.analytics.alumni_report.print
 */
Route::group(['prefix' => 'analytics', 'as' => 'analytics.', 'middleware' => ['can:Manage Alumni']], function () {
    Route::get('/', [EnhancedAnalyticsController::class, 'index'])->name('index');

    Route::group(['prefix' => 'alumni-report', 'as' => 'alumni_report.'], function () {
        Route::get('/', [AnalyticsAlumniReportController::class, 'index'])->name('index');
        Route::post('print', [AnalyticsAlumniReportController::class, 'print'])->name('print');
    });
});


// KSU Reports / Analytics (Admin)
Route::group(['prefix' => 'reports', 'as' => 'job_history_reports.', 'middleware' => ['can:Manage Alumni']], function () {
    Route::get('job-history', [JobHistoryReportController::class, 'index'])->name('index');
    Route::get('job-history/analytics', [JobHistoryReportController::class, 'analytics'])->name('analytics');
    Route::get('job-history/export', [JobHistoryReportController::class, 'export'])->name('export');
});

Route::group(['prefix' => 'reports', 'as' => 'tracer_surveys_reports.', 'middleware' => ['can:Manage Alumni']], function () {
    Route::get('tracer-surveys/analytics', [TracerSurveyReportController::class, 'analytics'])->name('analytics');
    Route::get('tracer-surveys/{survey}/results', [TracerSurveyReportController::class, 'results'])->name('results');
    Route::get('tracer-surveys/{survey}/export', [TracerSurveyReportController::class, 'export'])->name('export');
});
...
Route::group(['prefix' => 'setting', 'as' => 'setting.'], function () {
    ...
    Route::match(['get', 'post'], 'mail-configuration', [SettingController::class, 'mailConfiguration'])->name('mail-configuration');
    ...
    Route::post('sms-configuration', [SettingController::class, 'smsConfigurationStore']);
    ...
    Route::group(['prefix' => 'language', 'as' => 'languages.', 'middleware' => ['can:Manage Application Setting']], function () {
        ...
        Route::get('update-translate/{id}', [LanguageController::class, 'updateTranslate']);
...
// KSU Enrollment Sync
Route::group(['prefix' => 'enrollment-sync', 'as' => 'enrollment_sync.', 'middleware' => ['can:Manage Alumni']], function () {
    Route::get('/', [EnrollmentSyncController::class, 'index'])->name('index');
    Route::post('run', [EnrollmentSyncController::class, 'run'])->name('run');
});

// KSU Tracer Survey Builder
Route::group(['prefix' => 'tracer-surveys', 'as' => 'tracer_surveys.', 'middleware' => ['can:Manage Alumni']], function () {
    Route::get('/', [TracerSurveyController::class, 'index'])->name('index');
    Route::get('create', [TracerSurveyController::class, 'create'])->name('create');
    Route::post('store', [TracerSurveyController::class, 'store'])->name('store');
    Route::get('edit/{id}', [TracerSurveyController::class, 'edit'])->name('edit');
    Route::post('update/{id}', [TracerSurveyController::class, 'update'])->name('update');
    Route::post('publish/{id}', [TracerSurveyController::class, 'publish'])->name('publish');
    Route::post('unpublish/{id}', [TracerSurveyController::class, 'unpublish'])->name('unpublish');
    Route::post('delete/{id}', [TracerSurveyController::class, 'delete'])->name('delete');

    // Question builder
    Route::post('{surveyId}/questions/store', [TracerSurveyQuestionController::class, 'store'])->name('questions.store');
    Route::post('{surveyId}/questions/{questionId}/delete', [TracerSurveyQuestionController::class, 'delete'])->name('questions.delete');
    Route::post('{surveyId}/questions/{questionId}/options/store', [TracerSurveyQuestionController::class, 'storeOption'])->name('options.store');
    Route::post('{surveyId}/questions/{questionId}/options/{optionId}/delete', [TracerSurveyQuestionController::class, 'deleteOption'])->name('options.delete');
});

// KSU Admin view of Alumni Job History
Route::group(['prefix' => 'manage-alumni', 'as' => 'manage_alumni.', 'middleware' => ['can:Manage Alumni']], function () {
    Route::get('{alumniId}/job-history', [AlumniJobHistoryController::class, 'index'])->name('job_history.index');
});

// KSU Analytics / Reports (Job History + Tracer Surveys)
Route::group(['prefix' => 'reports', 'as' => 'job_history_reports.', 'middleware' => ['can:Manage Alumni']], function () {
    Route::get('job-history', [JobHistoryReportController::class, 'index'])->name('index');
    Route::get('job-history/analytics', [JobHistoryReportController::class, 'analytics'])->name('analytics');
    Route::get('job-history/export', [JobHistoryReportController::class, 'export'])->name('export');
...
if (!function_exists('isAddonInstalled') || !isAddonInstalled('ALUSAAS')) {
// version update
