...
use App\Http\Controllers\Alumni\JobHistoryController;
use App\Http\Controllers\Alumni\TracerSurveyController;
...
// KSU Job History (Alumni)
Route::group(['prefix' => 'job-history', 'as' => 'job_history.'], function () {
    Route::get('/', [JobHistoryController::class, 'index'])->name('index');
    Route::get('create', [JobHistoryController::class, 'create'])->name('create');
    Route::post('store', [JobHistoryController::class, 'store'])->name('store');
    Route::get('edit/{id}', [JobHistoryController::class, 'edit'])->name('edit');
    Route::post('update/{id}', [JobHistoryController::class, 'update'])->name('update');
    Route::post('delete/{id}', [JobHistoryController::class, 'delete'])->name('delete');
    Route::post('set-current/{id}', [JobHistoryController::class, 'setCurrent'])->name('set_current');
});

// KSU Tracer Surveys (Alumni)
Route::group(['prefix' => 'tracer-surveys', 'as' => 'tracer_surveys.'], function () {
    Route::get('/', [TracerSurveyController::class, 'index'])->name('index');
    Route::get('{id}', [TracerSurveyController::class, 'show'])->name('show');
    Route::post('{id}/submit', [TracerSurveyController::class, 'submit'])->name('submit');
});
