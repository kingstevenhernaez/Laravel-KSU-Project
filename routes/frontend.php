...
// public alumni directory (KSU)
Route::get('directory', [DirectoryController::class, 'index'])->name('directory');
// Alias used by updated homepage/navbar links
Route::get('directory', [DirectoryController::class, 'index'])->name('public.alumni.directory');
